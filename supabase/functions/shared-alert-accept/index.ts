...
serve(async (req) => {
  ...
  if (req.method === 'GET') {
    return confirmationPage(req, {
      title: 'Allow Pebble alerts?',
      message: 'This will let this Pebble Routines user email you when the routine finishes.',
...
<head>
  ...
  <style>
    ...
    button { width: 100%; border: 0; border-radius: 6px; padding: 14px 18px; background: #166534; color: #ffffff; font-size: 16px; font-weight: 700; cursor: pointer; }
  </style>
</head>
<body>
  <main>
