...
class ThemeMetadata {
  ...
  static const Map<ThemeId, ThemeMetadata> metadata = {
    ...
    ThemeId.matcha: ThemeMetadata(
      ...
      subtitle: 'Soft light',
      description: 'A fresh green palette for a calmer daytime surface.',
      category: ThemePickerCategory.premium,
      sortOrder: 910,
      isVisibleOnMainPicker: false,
      showInMoreOptionsOnly: true,
    ...
    ThemeId.terracotta: ThemeMetadata(
      ...
      description: 'Baked clay warmth with a toned, calmer accent.',
      category: ThemePickerCategory.premium,
      sortOrder: 920,
      isVisibleOnMainPicker: false,
      showInMoreOptionsOnly: true,
    ...
    ThemeId.lavenderAsh: ThemeMetadata(
      ...
      description: 'Soft plum and lavender for a calmer evening feel.',
      category: ThemePickerCategory.premium,
      sortOrder: 40,
    ),
